...
static void regist_ktl_random_engine() {
	...
	if (global) {
		sprig::krkr::tjs::AddNewMember(global.get(), SPRIG_KRKR_TJS_W("MinstdRand0"), ktl::CreateNativeClassMinstdRand0());
		sprig::krkr::tjs::AddNewMember(global.get(), SPRIG_KRKR_TJS_W("MinstdRand"), ktl::CreateNativeClassMinstdRand());
		sprig::krkr::tjs::AddNewMember(global.get(), SPRIG_KRKR_TJS_W("Rand48"), ktl::CreateNativeClassRand48());
		sprig::krkr::tjs::AddNewMember(global.get(), SPRIG_KRKR_TJS_W("Ecuyer1988"), ktl::CreateNativeClassEcuyer1988());
		sprig::krkr::tjs::AddNewMember(global.get(), SPRIG_KRKR_TJS_W("KnuthB"), ktl::CreateNativeClassKnuthB());
		sprig::krkr::tjs::AddNewMember(global.get(), SPRIG_KRKR_TJS_W("Kreutzer1986"), ktl::CreateNativeClassKreutzer1986());
		sprig::krkr::tjs::AddNewMember(global.get(), SPRIG_KRKR_TJS_W("Taus88"), ktl::CreateNativeClassTaus88());
		sprig::krkr::tjs::AddNewMember(global.get(), SPRIG_KRKR_TJS_W("Hellekalek1995"), ktl::CreateNativeClassHellekalek1995());
		sprig::krkr::tjs::AddNewMember(global.get(), SPRIG_KRKR_TJS_W("MT11213b"), ktl::CreateNativeClassMT11213b());
		sprig::krkr::tjs::AddNewMember(global.get(), SPRIG_KRKR_TJS_W("MT19937"), ktl::CreateNativeClassMT19937());
		sprig::krkr::tjs::AddNewMember(global.get(), SPRIG_KRKR_TJS_W("MT19937_64"), ktl::CreateNativeClassMT19937_64());
		sprig::krkr::tjs::AddNewMember(global.get(), SPRIG_KRKR_TJS_W("LaggedFibonacci607"), ktl::CreateNativeClassLaggedFibonacci607());
		sprig::krkr::tjs::AddNewMember(global.get(), SPRIG_KRKR_TJS_W("LaggedFibonacci1279"), ktl::CreateNativeClassLaggedFibonacci1279());
		sprig::krkr::tjs::AddNewMember(global.get(), SPRIG_KRKR_TJS_W("LaggedFibonacci2281"), ktl::CreateNativeClassLaggedFibonacci2281());
		sprig::krkr::tjs::AddNewMember(global.get(), SPRIG_KRKR_TJS_W("LaggedFibonacci3217"), ktl::CreateNativeClassLaggedFibonacci3217());
		sprig::krkr::tjs::AddNewMember(global.get(), SPRIG_KRKR_TJS_W("LaggedFibonacci4423"), ktl::CreateNativeClassLaggedFibonacci4423());
		sprig::krkr::tjs::AddNewMember(global.get(), SPRIG_KRKR_TJS_W("LaggedFibonacci9689"), ktl::CreateNativeClassLaggedFibonacci9689());
		sprig::krkr::tjs::AddNewMember(global.get(), SPRIG_KRKR_TJS_W("LaggedFibonacci9937"), ktl::CreateNativeClassLaggedFibonacci9937());
		sprig::krkr::tjs::AddNewMember(global.get(), SPRIG_KRKR_TJS_W("LaggedFibonacci23209"), ktl::CreateNativeClassLaggedFibonacci23209());
		sprig::krkr::tjs::AddNewMember(global.get(), SPRIG_KRKR_TJS_W("LaggedFibonacci44497"), ktl::CreateNativeClassLaggedFibonacci44497());
		sprig::krkr::tjs::AddNewMember(global.get(), SPRIG_KRKR_TJS_W("Ranlux3"), ktl::CreateNativeClassRanlux3());
		sprig::krkr::tjs::AddNewMember(global.get(), SPRIG_KRKR_TJS_W("Ranlux4"), ktl::CreateNativeClassRanlux4());
		sprig::krkr::tjs::AddNewMember(global.get(), SPRIG_KRKR_TJS_W("Ranlux64_3"), ktl::CreateNativeClassRanlux64_3());
		sprig::krkr::tjs::AddNewMember(global.get(), SPRIG_KRKR_TJS_W("Ranlux64_4"), ktl::CreateNativeClassRanlux64_4());
		sprig::krkr::tjs::AddNewMember(global.get(), SPRIG_KRKR_TJS_W("Ranlux3_01"), ktl::CreateNativeClassRanlux3_01());
		sprig::krkr::tjs::AddNewMember(global.get(), SPRIG_KRKR_TJS_W("Ranlux4_01"), ktl::CreateNativeClassRanlux4_01());
		sprig::krkr::tjs::AddNewMember(global.get(), SPRIG_KRKR_TJS_W("Ranlux64_3_01"), ktl::CreateNativeClassRanlux64_3_01());
		sprig::krkr::tjs::AddNewMember(global.get(), SPRIG_KRKR_TJS_W("Ranlux64_4_01"), ktl::CreateNativeClassRanlux64_4_01());
		//	CHECK: fatal error C1060
		//sprig::krkr::tjs::AddNewMember(global.get(), SPRIG_KRKR_TJS_W("Ranlux24"), ktl::CreateNativeClassRanlux24());
		//sprig::krkr::tjs::AddNewMember(global.get(), SPRIG_KRKR_TJS_W("Ranlux48"), ktl::CreateNativeClassRanlux48());
		sprig::krkr::tjs::AddNewMember(global.get(), SPRIG_KRKR_TJS_W("RandomDevice"), ktl::CreateNativeClassRandomDevice());
	}
}
