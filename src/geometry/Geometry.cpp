...
#define TJS_NATIVE_CLASSID_NAME GeometryClassID
	...
	SPRIG_KRKR_BEGIN_NATIVE_METHOD_DECL(disjoint)
	{
		...
		SPRIG_KRKR_RESULT_SET(
			Geometry::disjoint(SPRIG_KRKR_ARG_CLOSURE(0), SPRIG_KRKR_ARG_CLOSURE(1), SPRIG_KRKR_ARG_VARIANT(2), SPRIG_KRKR_ARG_VARIANT(3))
			);
		return TJS_S_OK;
	}
	...
	SPRIG_KRKR_BEGIN_NATIVE_METHOD_DECL(coveredBy)
	{
		...
		SPRIG_KRKR_TYPE_CHECK(3, tvtInteger);
		SPRIG_KRKR_RESULT_SET(
			Geometry::coveredBy(SPRIG_KRKR_ARG_CLOSURE(0), SPRIG_KRKR_ARG_CLOSURE(1), SPRIG_KRKR_ARG_VARIANT(2), SPRIG_KRKR_ARG_VARIANT(3))
			);
		return TJS_S_OK;
	}
	...
	SPRIG_KRKR_BEGIN_NATIVE_METHOD_DECL(within)
	{
		...
		SPRIG_KRKR_TYPE_CHECK(3, tvtInteger);
		SPRIG_KRKR_RESULT_SET(
			Geometry::within(SPRIG_KRKR_ARG_CLOSURE(0), SPRIG_KRKR_ARG_CLOSURE(1), SPRIG_KRKR_ARG_VARIANT(2), SPRIG_KRKR_ARG_VARIANT(3))
			);
		return TJS_S_OK;
	}
	...
	SPRIG_KRKR_BEGIN_NATIVE_METHOD_DECL(equals)
	{
		...
		SPRIG_KRKR_TYPE_CHECK(3, tvtInteger);
		SPRIG_KRKR_RESULT_SET(
			Geometry::equals(SPRIG_KRKR_ARG_CLOSURE(0), SPRIG_KRKR_ARG_CLOSURE(1), SPRIG_KRKR_ARG_VARIANT(2), SPRIG_KRKR_ARG_VARIANT(3))
			);
		return TJS_S_OK;
	}
	...
	SPRIG_KRKR_BEGIN_NATIVE_METHOD_DECL(overlaps)
	{
		...
		SPRIG_KRKR_TYPE_CHECK(3, tvtInteger);
		SPRIG_KRKR_RESULT_SET(
			Geometry::overlaps(SPRIG_KRKR_ARG_CLOSURE(0), SPRIG_KRKR_ARG_CLOSURE(1), SPRIG_KRKR_ARG_VARIANT(2), SPRIG_KRKR_ARG_VARIANT(3))
			);
		return TJS_S_OK;
	}
	...
	//	SPRIG_KRKR_TYPE_CHECK(3, tvtInteger);
	//	SPRIG_KRKR_RESULT_SET(
	//		Geometry::touches(SPRIG_KRKR_ARG_CLOSURE(0), SPRIG_KRKR_ARG_CLOSURE(1), SPRIG_KRKR_ARG_VARIANT(2), SPRIG_KRKR_ARG_VARIANT(3))
	//		);
	//	return TJS_S_OK;
	//}
	//SPRIG_KRKR_END_NATIVE_METHOD_DECL(touches);
	...
	//	SPRIG_KRKR_TYPE_CHECK(3, tvtInteger);
	//	SPRIG_KRKR_RESULT_SET(
	//		Geometry::crosses(SPRIG_KRKR_ARG_CLOSURE(0), SPRIG_KRKR_ARG_CLOSURE(1), SPRIG_KRKR_ARG_VARIANT(2), SPRIG_KRKR_ARG_VARIANT(3))
	//		);
	//	return TJS_S_OK;
	//}
	...
	//	SPRIG_KRKR_TYPE_CHECK(3, tvtInteger);
	//	SPRIG_KRKR_RESULT_SET(
	//		Geometry::intersects(SPRIG_KRKR_ARG_CLOSURE(0), SPRIG_KRKR_ARG_CLOSURE(1), SPRIG_KRKR_ARG_VARIANT(2), SPRIG_KRKR_ARG_VARIANT(3))
	//		);
	//	return TJS_S_OK;
	//}
	//SPRIG_KRKR_END_NATIVE_METHOD_DECL(intersects);
	SPRIG_KRKR_BEGIN_NATIVE_METHOD_DECL(distance)
	{
		...
		SPRIG_KRKR_TYPE_CHECK(3, tvtInteger);
		SPRIG_KRKR_RESULT_SET(
			Geometry::distance(SPRIG_KRKR_ARG_CLOSURE(0), SPRIG_KRKR_ARG_CLOSURE(1), SPRIG_KRKR_ARG_VARIANT(2), SPRIG_KRKR_ARG_VARIANT(3))
			);
		return TJS_S_OK;
	}
